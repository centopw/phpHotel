...
@section('content')
    <div class="fh5co-parallax" style="background-image: url(assets/home-assets/images/slider1.jpg);" data-stellar-background-ratio="0.5">
    ...
    <div id="fh5co-blog-section">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="blog-grid" style="background-image: url(assets/home-assets/images/image-4.jpg);">
                        <div class="date text-center">
                            <span>09</span>
                            <small>Aug</small>
                        </div>
                ...
                <div class="col-md-4">
                    <div class="blog-grid" style="background-image: url(assets/home-assets/images/image-5.jpg);">
                        <div class="date text-center">
                            <span>09</span>
                            <small>Aug</small>
                        </div>
                ...
                <div class="col-md-4">
                    <div class="blog-grid" style="background-image: url(assets/home-assets/images/image-6.jpg);">
                        <div class="date text-center">
                            <span>09</span>
                            <small>Aug</small>
                        </div>
