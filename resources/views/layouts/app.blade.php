...
<head>
    ...
    <link rel="stylesheet"
        href="{{ asset('assets/admin-assets/plugins/tempusdominus-bootstrap-4/css/tempusdominus-bootstrap-4.min.css') }}">
    <!-- iCheck -->
    ...
    <!-- overlayScrollbars -->
    <link rel="stylesheet"
        href="{{ asset('assets/admin-assets/plugins/overlayScrollbars/css/OverlayScrollbars.min.css') }}">
    <!-- Scripts -->
...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <div class="preloader flex-column justify-content-center align-items-center">
            <img class="animation__shake" src="{{ asset('assets/admin-assets/dist/img/AdminLTELogo.png') }}"
